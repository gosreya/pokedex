...
- As mentioned by the author, suggestions off by 1 letter are considered infinitely more likely than suggestions off by 2 letters
"""
class SpellCorrector:
  ...
  def P(self, og, suggestion): 
      """
      Here, I assume that the user is likelier to get the consonants of the name more correctly than the vowels, so I give more weight to the suggestions with the same consonants.
      """
